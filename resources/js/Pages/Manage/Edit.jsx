...
export default function Create({ auth, manage }) {
  const { data, setData, put, errors, reset } = useForm({
    IntentionType: manage.data.IntentionType || "",
    DateOfMass: manage.data.DateOfMass || "",
    TimeOfMass: manage.data.TimeOfMass || "",
    Offerer: manage.data.Offerer || "",
    OfferedFor: manage.data.OfferedFor || "",
    ContactNo: manage.data.ContactNo || "",
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    put(route('manage.update', {manage: manage.data.IntentionID}));
  };
