...
export default function Index({ manage, queryParams = null, success }) {
    ...
    const handleDelete = () => {
        if (itemToDelete) {
            router.delete(route('manage.destroy', itemToDelete.IntentionID), {
                onSuccess: () => {
                    setShowDeleteModal(false);
                    setNotificationMessage('Intention was Deleted');
                    setShowNotification(true);
            ...
            {showDeleteModal && (
                <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
                        <h3 className="text-lg font-semibold mb-4">Are you sure you want to delete this Intention?</h3>
